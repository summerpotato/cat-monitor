package net.tomjerry.catmonitor.dubbospi.registry;
    ...
    class RegistryWrapper implements Registry {
        ...
        private URL appendProviderAppName(URL url){
            ...
            if(Constants.PROVIDER_SIDE.equals(side)){
                url = url.addParameter(CatConstants.DUBBO_PROVIDER_APPLICATION_NAME, url.getParameter(Constants.APPLICATION_KEY));
            }
            return url;
        }
